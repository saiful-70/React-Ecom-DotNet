#!/bin/bash
# Deploy — PRODUCTION (bdbazaronline.com)
#
...
# fails with "spawn ... EAGAIN"). Never uploads/deletes .env.production — the
# server owns its runtime env; NEXT_PUBLIC_* are baked in from the local build.
#
